...
function M.set()
	...
	style.FramePadding = vmath.vector3(10, 9, 0)
	style.FrameRounding = 10
	--	style.FrameBorderSize = 0
	style.ItemSpacing = vmath.vector3(10, 7, 0)
	...
	style.WindowPadding = vmath.vector3(20, 20, 0)
	...
	imgui.set_style_color(imgui.ImGuiCol_TitleBgCollapsed, 0.40, 0.40, 0.80, 0.60)
